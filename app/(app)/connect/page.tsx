      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        ...
        {params.error && (
          <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-xl">
            <div className="flex items-center gap-2">
              ...
              <p className="text-red-800 font-medium">Erreur: {params.error}</p>
            </div>
          </div>
        )}
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Connexion Stripe</h1>
              <p className="text-gray-500">Synchronise tes abonnes automatiquement</p>
            </div>
          </div>
            ...
            <>
              ...
              <div className="p-4 bg-green-50 border border-green-200 rounded-xl mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-green-800">Compte Stripe connecte</p>
              ...
              {/* Sync button */}
              <div className="mb-6">
                <h2 className="text-lg font-semibold text-gray-900 mb-2">Synchroniser les donnees</h2>
                <p className="text-gray-600 text-sm mb-4">
                  Importe tes clients et abonnements Stripe dans Abo.
                </p>
                <SyncButton />
              </div>
              ...
              <div className="pt-6 border-t border-gray-200">
                <h2 className="text-lg font-semibold text-gray-900 mb-2">Deconnecter Stripe</h2>
                <p className="text-gray-600 text-sm mb-4">
...
// Client component for sync button
function SyncButton() {
  return (

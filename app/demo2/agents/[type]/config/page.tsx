...
const agentActionTypes: Record<AgentType, { type: string; label: string; hasAmount?: boolean; amountUnit?: string; warning?: string }[]> = {
  recovery: [
    ...
    { type: 'offer_payment_extension', label: 'Proposer un délai de paiement' },
    { type: 'update_payment_method_request', label: 'Demander mise à jour CB' },
  ],
  retention: [
    { type: 'send_winback_email', label: 'Envoyer un email de reconquête' },
    { type: 'offer_discount', label: 'Offrir une réduction', hasAmount: true, amountUnit: '%' },
  ...
  conversion: [
    ...
    { type: 'offer_trial_extension', label: 'Prolonger la période d\'essai' },
    { type: 'offer_first_month_discount', label: 'Offrir une réduction 1er mois', hasAmount: true, amountUnit: '%' },
...
const agentDescriptions: Record<AgentType, string> = {
  recovery: 'Récupère les paiements échoués et relance les clients',
...
const confidenceLevels: { value: ConfidenceLevel; label: string; description: string }[] = [
  { value: 'review_all', label: 'Je valide tout', description: 'Chaque action nécessite ton approbation' },
  { value: 'auto_with_copy', label: 'Auto avec copie', description: 'L\'agent agit, tu reçois une copie de chaque action' },
    ...
    return (
      <div className="max-w-3xl mx-auto">
        <div className="text-center py-12">
          ...
          <Button onClick={() => router.push('/demo2/agents')}>
            Retour aux agents
          </Button>
        </div>
      </div>
    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-gray-500 mb-4">Configure quelles actions nécessitent ton approbation</p>
        ...
        <div className="flex items-center justify-between pt-4 pb-8">
          <Link
            href={`/demo2/agents/${agentType}/history`}
